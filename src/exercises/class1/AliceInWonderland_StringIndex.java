...
public class AliceInWonderland_StringIndex {
    public static void main(String[] args) {
        ...
        if (aliceReference.toLowerCase().contains(" " + userInput.toLowerCase() + " ")) {
            int indexStart = aliceReference.toLowerCase().indexOf(" " + userInput.toLowerCase() + " ")+1;
            int indexEnd = indexStart + userInput.length()+1;
        ...
        else if (aliceReference.toLowerCase().contains(" " + userInput.toLowerCase() + ":"))
        {
            int indexStart = aliceReference.toLowerCase().indexOf(" " + userInput.toLowerCase() + ":")+1;
            int indexEnd = indexStart + userInput.length();

            System.out.println("The index for " + userInput + " is: " + indexStart + " and the word is " + userInput.length() + " letters long");
            System.out.println(aliceReference.substring(0, indexStart-1) + aliceReference.substring(indexEnd, aliceEnd));
        }
        else if (aliceReference.toLowerCase().contains(" " + userInput.toLowerCase() + ","))
        {
            int indexStart = aliceReference.toLowerCase().indexOf(" " + userInput.toLowerCase() + ",")+1;
